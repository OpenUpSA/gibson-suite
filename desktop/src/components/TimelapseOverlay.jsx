...
// Draggable / resizable crop-box overlay rendered on top of a map.
// Props:
//   map        — MapLibre map instance (used for project/unproject)
//   rectangle  — [[swLng, swLat], [neLng, neLat]] | null
//   aspectRatio— number to lock aspect (e.g. 16/9, 1) or null for freeform
//   onChange   — ([[swLng, swLat], [neLng, neLat]]) => void
// Ported from the legacy TimelapseSelectionOverlay.
export default function TimelapseOverlay({ map, rectangle, aspectRatio, onChange }) {
